...
A `.yx6` is packed out of a YM file or a RhYMe `.YMR`, and neither crosses
whole. This is what each front end changes, what it counts, and what it
tells you it did. [README.md](README.md) is how to run the packers,
[FORMAT.md](FORMAT.md) the container they write.
...
and `$FF` is precisely what [FORMAT.md](FORMAT.md)'s **Writing the chip** means by it, the value

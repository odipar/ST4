...
was a YX6 bug. Both were real, both had different causes, and pinning
...
Every YM player renders this identically - ST-Sound, ym2149-rs, YX6 -
because it is in the file. The faithful Chambers of Shaolin is the
SNDH; the dump's drums are a cover version.

## What it cost YX6, and what it changed

Chasing the perception exposed one real YX6 weakness on the way: the
...
would free YX6 from dump quality entirely. A real project, not started;
